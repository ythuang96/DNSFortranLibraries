...
#   include "parameters"
    ...
    public :: h5save_RPartial_Init, h5save_R2Partial_SingleDim2, h5save_R3Partial_SingleDim3
    public :: h5save_CPartial_Init
    public :: h5save_C3Partial_SingleDim3, h5save_C3Partial_SingleDim2
    public :: h5save_C3Serial_dim3, h5save_C3Serial_dim2
    public :: h5save_C4Partial_SingleDim3
...
contains
    ...
    ! subroutine h5save_C4Partial_SingleDim3( filename, varname, matrix, dim3index )
    ...
    subroutine h5save_C4Partial_SingleDim3( filename, varname, matrix, dim3index)
        ...
        ! Deallocate temp buffer
        DEALLOCATE(temp)
    end subroutine h5save_C4Partial_SingleDim3
